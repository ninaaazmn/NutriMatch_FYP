...
const ProfileFormView: React.FC = () => (
  <form className="profile-form">
    <div className="profile-form-header">
      ...
      <span className="profile-name">Raihanah</span>
    </div>

    <div className="form-group">
      <label>Name</label>
      <input type="text" defaultValue="Raihanah" />
    </div>
    <div className="form-group">
      <label>Email</label>
      <input type="email" defaultValue="raihanah1234@gmail.com" />
    </div>
    <div className="form-group">
...
const EditPreferencesView: React.FC = () => {
  const [diet, setDiet] = useState("No specific diet");
  const [allergies, setAllergies] = useState<string[]>(["Shellfish"]);
      ...
      <div className="pref-group">
        ...
        <div className="pref-options">
          {["No specific diet", "Vegetarian", "Vegan", "Pescatarian", "Keto", "Paleo"].map(item => (
            <div
              key={item}
              className={`pref-option ${diet === item ? "selected" : ""}`}
      ...
      <div className="pref-group">
        ...
        <div className="pref-options">
          {["Shellfish", "Dairy", "Nuts", "Eggs", "Soy", "Gluten"].map(item => (
            <div
              key={item}
              className={`pref-option ${allergies.includes(item) ? "selected" : ""}`}
      ...
      <div className="pref-group">
        ...
        <div className="pref-options">
          {["Indian", "Mexican", "American", "Asian", "Mediterranean", "Italian"].map(item => (
            <div
              key={item}
              className={`pref-option ${cuisine.includes(item) ? "selected" : ""}`}
